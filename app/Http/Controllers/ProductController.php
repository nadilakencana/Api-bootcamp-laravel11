...
{
    // Funtion Admin CRUD Product
    //funtion get untuk  user client / admin
     ...
     public function UpdateDataProdut(Request $request, $slug)
    {
        $validator = Validator::make($request->all(), [
            ...
            'description' => 'required',
            'price' => 'required',
            'image' => 'file|mimes:jpeg,png,jpg,gif|max:10048',
            'id_category' => 'required',
        ]);
    ...
    // api funtion client user product
    ...
    {
        try {
            $products_category = Product::whereHas('Category', function ($query) use ($slug){
